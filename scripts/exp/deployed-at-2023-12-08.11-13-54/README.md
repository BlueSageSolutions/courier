...
**Command**: `/bin/cat /tmp/cloudquery-ecs_main_step-4.json | /usr/local/bin/jq .Role.Arn -r`

**Script Reference**: `cloudquery-ecs:main:step-8`

**Output**:

```json
arn:aws:iam::609251059722:role/bluesage-devops-cloudquery-task-role

```

**Command**: `/bin/cat /tmp/_task-definition.json | /bin/cat`

**Script Reference**: `cloudquery-ecs:main:step-9`
...
```json
{
  "containerDefinitions": [
    {
      ...
      "environment": [
        { "name": "CQ_CONFIG", "value": "" }
      ],
      "logConfiguration": {
        "logDriver": "awslogs",
        "options": {
  ...
  "memory": "2048",
  "networkMode": "awsvpc",
  "taskRoleArn": "arn:aws:iam::609251059722:role/bluesage-devops-cloudquery-task-role",
  "executionRoleArn": "arn:aws:iam::609251059722:role/bluesage-devops-cloudquery-task-role"
}
